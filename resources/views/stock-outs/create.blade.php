            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="transaction_id"
                        name="transaction_id" 
                        value="{{ old('transaction_id', $transactionId ?? \App\Models\StockOut::generateTransactionId()) }}" 
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm font-semibold text-blue-600 @error('transaction_id') border-red-500 @enderror"
                        required
                    >
